...
namespace ExCSS
{
    public sealed class StyleDeclaration : StylesheetNode, IProperties
    {
        ...
        {
            get => (AnimationDirectionProperty)GetProperty(PropertyNames.AnimationDirection);
            set => SetProperty(PropertyNames.AnimationDirection, value.ValueText);
        }

        public AnimationDurationProperty AnimationDuration
        {
            get => (AnimationDurationProperty)GetProperty(PropertyNames.AnimationDuration);
        ...
        {
            get => (AnimationIterationCountProperty)GetProperty(PropertyNames.AnimationIterationCount);
            set => SetProperty(PropertyNames.AnimationIterationCount, value.ValueText);
        }
